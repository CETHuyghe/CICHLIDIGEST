...
#apptainer exec /scicore/home/salzburg/huyghe0000/sinergia/DNA_gut/MAGs/metabat_v2.18-9-g006aca3.sif jgi_summarize_bam_contig_depths  --outputDepth $out/${sample}_mapping.depth $out/${sample}_mapping.bam
