...
#SBATCH --account=salzburg
#SBATCH --time=00:30:00
#SBATCH --mem=100G # Normally 10
#SBATCH --nodes=1
...
apptainer exec /scicore/home/salzburg/huyghe0000/sinergia/DNA_gut/MAGs/metabat_v2.18-9-g006aca3.sif jgi_summarize_bam_contig_depths  --outputDepth  $output/depths/${assembly}_depths.txt $input/*.bam
...
mkdir -p $output/MAGs
apptainer exec metabat_v2.18-9-g006aca3.sif metabat2 -i $assembly_file -a $output/depths/${assembly}_depths.txt -o $output/MAGs/${assembly}_MAG -m 2000 --maxEdges 500 -t $threads
