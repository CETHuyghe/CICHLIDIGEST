...
megahit -1 $R1 -2 $R2 -o $out --out-prefix $prefix --presets meta-sensitive -t $threads # it may help to add --presets meta-large or --presets meta-sensitive https://www.metagenomics.wiki/tools/assembly/megahit
